...
import { View, StyleSheet, Image, TouchableOpacity, ScrollView, Dimensions, Animated } from "react-native";
...
const videoArray = [
  ...
  return (
    ...
    {/* <VideoSlider videos={videoArray} /> */}
      ...
      <TouchableOpacity style={{ paddingHorizontal: 10 }}  onPress={() => navigation.navigate("communityDetails")}>
        <CustomText style={{ fontSize: 12, color: colors.textSecondary, fontWeight: '800' }}>
