...
import { ADD_EVENT_POST_IMAGE } from "../constants/apiEndpoints";
...
const PostImages = () => {
  ...
  const uploadImages = async () => {
    ...
    try {
      setIsLoading(true);
      const formattedImages = images.map((uri, index) => {
  ...
  return (
    <Container>
      ...
      <View style={styles.header}>
        ...
        <Title title="Post Images" color={colors.black} />
